...
builder.Services.AddMongo()
    ...
    .AddMongoRepo<CatalogueItem>("catalogueitems")
    .AddMassTransitWithRabbitMq();


AddCatalogueClient(builder);
...
void AddCatalogueClient(WebApplicationBuilder webApplicationBuilder)
{
//Http client with jitter config
    Random jitter = new Random();

    webApplicationBuilder.Services
        .AddHttpClient<CatalogClient>(client => { client.BaseAddress = new Uri("https://localhost:7212"); })
